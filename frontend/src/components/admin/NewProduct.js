  ...
  useEffect(() => {
    if(isProductCreated) {
        toast('Product Created Successfully', {
            ...
            onOpen: () => { dispatch(clearProductCreated()) } //here we set the isUpdated val as false after the toast message shown so we don't get toast message every time open the updated page after got updated message
        })
