  ...
  useEffect(() => {
    ...
    if(isUserDeleted) {
      toast('User Deleted Successfully', {
          type: 'success',
          position: 'bottom-center',
          onOpen: () => { dispatch(clearUserDeleted()) } //here we set the isUpdated val as false after the toast message shown so we don't get toast message every time open the updated page after got updated message
      })
      return;
    }
